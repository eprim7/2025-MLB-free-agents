...
# HITTERS
advanced_hitters_2023_stats = pd.read_csv('baseball_reference_stats/advanced_stats_hitters_2023.csv')
advanced_hitters_2024_stats = pd.read_csv('baseball_reference_stats/advanced_stats_hitters_2024.csv')
advanced_hitters_2025_stats = pd.read_csv('baseball_reference_stats/advanced_stats_hitters_2025.csv')
...
# 2023 Hitters
hitters_2023_merged = pd.merge(hitters_2023_substats, hitters_2023_stats,left_on='Player', right_on='Name', how='right')
hitters_2023_merged.to_csv('total_uncleaned_stats/2023_free_agent_hitters_stats.csv', index=False)

# 2024 Hitters
hitters_2024_merged = pd.merge(hitters_2024_substats, hitters_2024_stats, left_on='Player', right_on='Name', how='right')
hitters_2024_merged.to_csv('total_uncleaned_stats/2024_free_agent_hitters_stats.csv', index=False)

# 2025 Hitters
hitters_2025_merged = pd.merge(hitters_2025_substats, hitters_2025_stats, left_on='Player', right_on='Name', how='right')
hitters_2025_merged.to_csv('total_uncleaned_stats/2025_free_agent_hitters_stats.csv', index=False)


# PITCHERS
advanced_pitchers_2023_stats = pd.read_csv('baseball_reference_stats/advanced_stats_pitchers_2023.csv')
advanced_pitchers_2024_stats = pd.read_csv('baseball_reference_stats/advanced_stats_pitchers_2024.csv')
advanced_pitchers_2025_stats = pd.read_csv('baseball_reference_stats/advanced_stats_pitchers_2025.csv')
...
# 2023 Pitchers
pitchers_2023_merged = pd.merge(pitchers_2023_substats, pitchers_2023_stats,left_on='Player', right_on='Name', how='right')
pitchers_2023_merged.to_csv('total_uncleaned_stats/2023_free_agent_pitchers_stats.csv', index=False)

# 2024 Pitchers
pitchers_2024_merged = pd.merge(pitchers_2024_substats, pitchers_2024_stats, left_on='Player', right_on='Name', how='right')
pitchers_2024_merged.to_csv('total_uncleaned_stats/2024_free_agent_pitchers_stats.csv', index=False)

# 2025 Pitchers
pitchers_2025_merged = pd.merge(pitchers_2025_substats, pitchers_2025_stats, left_on='Player', right_on='Name', how='right')
pitchers_2025_merged.to_csv('total_uncleaned_stats/2025_free_agent_pitchers_stats.csv', index=False)
